...
struct event_loop
{
    ...
    strcut channel_element *pending_tail;
...
// dispatcher派发完事件后，调用方法通知event_loop执行事件相关的callback方法
int channel_event_active(struct event_loop *eventLoop, int fd, int res);
